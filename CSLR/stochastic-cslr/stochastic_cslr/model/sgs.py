...
class SGSResNet18(nn.Module):
    def __init__(self, dim, p_detach=0):
        ...
        #self.encoder.load_state_dict(torch.load("/home/asandygulova/dock/models/vgg11.pth"))
        #self.encoder.load_state_dict(torch.load("/raid/asandygulova/CSLR/stochastic-cslr/models/vgg11.pth"))
